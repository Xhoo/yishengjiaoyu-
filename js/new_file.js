!function (e, t) {
    function n() {
        ...
        t / u > 540 && (t = 540 * u);
        var n = t / 10;
        o.style.fontSize = n + "px", c.rem = e.rem = n
    }

    var r, i = e.document, o = i.documentElement, a = i.querySelector('meta[name="viewport"]'), s = i.querySelector('meta[name="flexible"]'), u = 0, l = 0, c = t.flexible || (t.flexible = {});
    if (a) {
        ...
        if (p) {
            ...
            d && (u = parseFloat(d[1]), l = parseFloat((1 / u).toFixed(2))), h && (u = parseFloat(h[1]), l = parseFloat((1 / u).toFixed(2)))
        }
    }
    if (!u && !l) {
        var g = (e.navigator.appVersion.match(/android/gi), e.navigator.appVersion.match(/iphone/gi)), m = e.devicePixelRatio;
        u = g ? m >= 3 && (!u || u >= 3) ? 3 : m >= 2 && (!u || u >= 2) ? 2 : 1 : 1, l = 1 / u
    }
    if (o.setAttribute("data-dpr", u), !a)if (a = i.createElement("meta"), a.setAttribute("name", "viewport"), a.setAttribute("content", "initial-scale=" + l + ", maximum-scale=" + l + ", minimum-scale=" + l + ", user-scalable=no"), o.firstElementChild)o.firstElementChild.appendChild(a); else {
    ...
    }, !1), "complete" === i.readyState ? i.body.style.fontSize = 12 * u + "px" : i.addEventListener("DOMContentLoaded", function (e) {
        i.body.style.fontSize = 12 * u + "px"
    }, !1), n(), c.dpr = e.dpr = u, c.refreshRem = n, c.rem2px = function (e) {
    ...
    var e = "@charset \"utf-8\";html{color:#000;overflow-y:scroll;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%}html,body{font-family:sans-serif}body,div,dl,dt,dd,ul,ol,li,h1,h2,h3,h4,h5,h6,pre,code,form,fieldset,legend,input,textarea,p,blockquote,th,td,hr,button,article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{margin:0;padding:0}input,select,textarea{font-size:100%}table{border-collapse:collapse;border-spacing:0}fieldset,img{border:0}abbr,acronym{border:0;font-variant:normal}del{text-decoration:line-through}address,caption,cite,code,dfn,em,th,var{font-style:normal;font-weight:500}ol,ul{list-style:none}caption,th{text-align:left}h1,h2,h3,h4,h5,h6{font-size:100%;font-weight:500}q:before,q:after{content:''}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sup{top:-.5em}sub{bottom:-.25em}a:hover{text-decoration:none}ins,a{text-decoration:none}", t = document.createElement("style");
    ...
    function D(e, t, r, i) {
        ...
        if (p && (o = x(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
            ...
            if (u)for (c = s[s.length - 1].ownerDocument, he.map(s, S), f = 0; f < u; f++)l = s[f], Ve.test(l.type || "") && !Oe.access(l, "globalEval") && he.contains(c, l) && (l.src ? he._evalUrl && he._evalUrl(l.src) : n(l.textContent.replace(it, ""), c))
        }
        return e
    }
    ...
    function V(e, t, n, r) {
        ...
        if (he.isArray(t))he.each(t, function (t, i) {
            n || St.test(e) ? r(e, i) : V(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
    ...
    var xe = function (e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : $) !== F && L(t), t = t || F, O)) {
        ...
        function b(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function (r, a, s, u, l) {
                var c, f, p, d = 0, h = "0", g = r && [], m = [], y = D, x = r || o && C.find.TAG("*", l), b = B += null == y ? 1 : Math.random() || .1, w = x.length;
                for (l && (D = a === F || a || l); h !== w && null != (c = x[h]); h++) {
                    if (o && c) {
                        for (f = 0, a || c.ownerDocument === F || (L(c), s = !O); p = e[f++];)if (p(c, a || F, s)) {
                            u.push(c);
                            break
                        }
                        l && (B = b)
        ...
        var w, T, C, E, k, S, N, j, D, A, q, L, F, H, O, P, R, M, I, W = "sizzle" + 1 * new Date, $ = e.document, B = 0, _ = 0, z = n(), X = n(), U = n(), V = function (e, t) {
            return e === t && (q = !0), 0
        ...
        T = t.support = {}, k = t.isXML = function (e) {
            ...
            return r !== F && 9 === r.nodeType && r.documentElement ? (F = r, H = F.documentElement, O = !k(F), $ !== F && (n = F.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), T.attributes = i(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), T.getElementsByTagName = i(function (e) {
                return e.appendChild(F.createComment("")), !e.getElementsByTagName("*").length
            }), T.getElementsByClassName = me.test(F.getElementsByClassName), T.getById = i(function (e) {
            ...
            }, R = [], P = [], (T.qsa = me.test(F.querySelectorAll)) && (i(function (e) {
            ...
            })), (T.matchesSelector = me.test(M = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && i(function (e) {
                T.disconnectedMatch = M.call(e, "*"), M.call(e, "[s!='']:x"), R.push("!=", oe)
            }), P = P.length && new RegExp(P.join("|")), R = R.length && new RegExp(R.join("|")), t = me.test(H.compareDocumentPosition), I = t || me.test(H.contains) ? function (e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !T.sortDetached && t.compareDocumentPosition(e) === n ? e === F || e.ownerDocument === $ && I($, e) ? -1 : t === F || t.ownerDocument === $ && I($, t) ? 1 : A ? ee(A, e) - ee(A, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t)return q = !0, 0;
                var n, r = 0, i = e.parentNode, o = t.parentNode, s = [e], u = [t];
                if (!i || !o)return e === F ? -1 : t === F ? 1 : i ? -1 : o ? 1 : A ? ee(A, e) - ee(A, t) : 0;
                if (i === o)return a(e, t);
            ...
            if ((e.ownerDocument || e) !== F && L(e), n = n.replace(ce, "='$1']"), T.matchesSelector && O && !U[n + " "] && (!R || !R.test(n)) && (!P || !P.test(n)))try {
                var r = M.call(e, n);
            ...
            return (e.ownerDocument || e) !== F && L(e), I(e, t)
        }, t.attr = function (e, t) {
    ...
    var ke, Se = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, Ne = he.fn.init = function (e, t, n) {
        var r, i;
        if (!e)return this;
    ...
    Ne.prototype = he.fn, ke = he(te);
    var je = /^(?:parents|prev(?:Until|All))/, De = {children: !0, contents: !0, next: !0, prev: !0};
    he.fn.extend({
        has: function (e) {
    ...
    he.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || he.isXMLDoc(e)))for (a = v(s), o = v(e), r = 0, i = o.length; r < i; r++)j(o[r], a[r]);
    ...
    he.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return t = he.cssProps[s] || (he.cssProps[s] = F(s) || s), a = he.cssHooks[t] || he.cssHooks[s], void 0 === n ? a && "get"in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = We.exec(n)) && i[1] && (n = h(e, t, i), o = "number"), void(null != n && n === n && ("number" === o && (n += i && i[3] || (he.cssNumber[s] ? "" : "px")), pe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set"in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n))))
            }
        },
        css: function (e, t, n, r) {
            var i, o, a, s = he.camelCase(t);
            return t = he.cssProps[s] || (he.cssProps[s] = F(s) || s), a = he.cssHooks[t] || he.cssHooks[s], a && "get"in a && (i = a.get(e, !0, n)), void 0 === i && (i = q(e, t, r)), "normal" === i && t in ct && (i = ct[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
        }
        ...
        he.cssHooks[t] = {
            get: function (e, n, r) {
                ...
                return a && (i = We.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = he.css(e, t)), H(e, n, a)
            }
        }
    ...
    he.fn.extend({
        attr: function (e, t) {
            return Fe(this, he.attr, e, t, arguments.length > 1)
    ...
    he.fn.extend({
        prop: function (e, t) {
            return Fe(this, he.prop, e, t, arguments.length > 1)
    ...
    he.extend(he.event, {
        trigger: function (t, n, r, i) {
            ...
            if (a = s = r = r || te, 3 !== r.nodeType && 8 !== r.nodeType && !Tt.test(d + he.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[he.expando] ? t : new he.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : he.makeArray(n, [t]), f = he.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                ...
                for (o = 0; (a = p[o++]) && !t.isPropagationStopped();)t.type = o > 1 ? u : f.bindType || d, c = (Oe.get(a, "events") || {})[t.type] && Oe.get(a, "handle"), c && c.apply(a, n), c = l && a[l], c && c.apply && He(a) && (t.result = c.apply(a, n), t.result === !1 && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || f._default && f._default.apply(p.pop(), n) !== !1 || !He(r) || l && he.isFunction(r[d]) && !he.isWindow(r) && (s = r[l], s && (r[l] = null), he.event.triggered = d, r[d](), he.event.triggered = void 0, s && (r[l] = s)), t.result
            }
    ...
    var At = /%20/g, qt = /#.*$/, Lt = /([?&])_=[^&]*/, Ft = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ht = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ot = /^(?:GET|HEAD)$/, Pt = /^\/\//, Rt = {}, Mt = {}, It = "*/".concat("*"), Wt = te.createElement("a");
...
//coursemangement
window.url = url;
//window.href="k1602677i8.iok.la/yishengjiaoyu/html/jiaoshi";

//教师中心 我的主页
var TEACHERHOMEHTML = 'yishengjiaoyu/html/jiaoshi/my_homepage.html';
//生源大厅
var SOURCECENTER = 'yishengjiaoyu/html/jiaoshi/source_center.html';
//教师中心 课程管理
var COURSEMANAGEMENT = 'yishengjiaoyu/html/jiaoshi/course_management.html';
//课程管理 基本信息
...
//课程表
var MYLESSONS = 'yishengjiaoyu/html/jiaoshi/my_lessons.html';
//钱包
var TEACHERWALL = 'yishengjiaoyu/html/bankcard/myWallet.html';
//
var ORDERTEACHERFORM = 'yishengjiaoyu/html/myOrderForm/myOrder.html?id=1';
...
//全局URL
function href() {
    var location = 'http://k1602677i8.iok.la/lifetime/';
    return location;
    /*var location = 'k1602677i8.iok.la//lifetime/';
     return location;*/
}
//页面跳转URL
function locationHref() {
    ...
    //  return locationHref;*/
    /*var locationHref = 'file:///C://workproject/p3/';*/
    return locationHref;
}
/**
 * @author rongjie
